        ...
        <div className='bg-gradient-to-r from-black to-blue-950 text-white pt-4 px-32'>
             <div className='flex justify-between items-center'>
              <div className='flex justify-center items-center gap-4 '>
                <img onClick={()=>navigate('/')} src={image} alt="" className='w-16 rounded-full'/>
                <Link to={'/'} className='text-2xl text-orange-400'>DIGITALEARN</Link>
              </div>
              <div className='flex justify-center gap-6'>
                <button onClick={()=>navigate('/login')} className='border border-white rounded-md py-2 px-4 font-bold text-xl hover:text-lg transition-all duration-300'>Login</button>
                <button onClick={()=>navigate('/signup')} className='border border-white rounded-md py-2 px-4 font-bold text-xl hover:text-lg transition-all duration-300 bg-orange-400'>Join now</button>
              </div>
             </div>
            </div>
      </header>
        ...
        <div className="bg-gray-900 rounded-lg shadow-lg w-[400px] p-8 mt-20 mb-32 ">
          ...
          <form onSubmit={handleSubmit}>
            ...
            >
             ...
             <p className="mt-2 items-center text-center text-xl">Already have an Account <Link className="pl-2 text-blue-500 underline" to={'/login'}>Login</Link></p>
          </form>
        </div>
      </div>
    </div>
